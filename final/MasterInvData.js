...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
document.getElementById("aceAcid").innerHTML += Math.max(0, localStorage.getItem("Acetic Acid"));
document.getElementById("aceAcidc").innerHTML += (localStorage.getItem("Acetic Acid") * 0.66).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("albaSPlus").innerHTML += Math.max(0, localStorage.getItem("Albaflow SF Plus"));
document.getElementById("albaSPlusc").innerHTML += (localStorage.getItem("Albaflow SF Plus") * 2.92).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("albaSConc").innerHTML += Math.max(0, localStorage.getItem("Albafluid SL Conc"));
document.getElementById("albaSConcc").innerHTML += (localStorage.getItem("Albafluid SL Conc") * 1.25).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("albeA").innerHTML += Math.max(0, localStorage.getItem("Albegal A"));
document.getElementById("albeAc").innerHTML += (localStorage.getItem("Albegal A") * 3.32).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("albeE3B").innerHTML += Math.max(0, localStorage.getItem("Albegal E3-B"));
...
document.getElementById("albeSet").innerHTML += Math.max(0, localStorage.getItem("Albegal Set"));
document.getElementById("albeSetc").innerHTML += (localStorage.getItem("Albegal Set") * 4.15).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("clariBac").innerHTML += Math.max(0, localStorage.getItem("Clarite Bac"));
document.getElementById("clariBacc").innerHTML += (localStorage.getItem("Clarite Bac") * 2.72).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("colCle").innerHTML += Math.max(0, localStorage.getItem("Color Clear"));
document.getElementById("colClec").innerHTML += (localStorage.getItem("Color Clear") * 4.06).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("eriE3S").innerHTML += Math.max(0, localStorage.getItem("Eriopon E3-Save"));
document.getElementById("eriE3Sc").innerHTML += (localStorage.getItem("Eriopon E3-Save") * 2.75).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("eriLan").innerHTML += Math.max(0, localStorage.getItem("Eriopon Lan"));
document.getElementById("eriLanc").innerHTML += (localStorage.getItem("Eriopon Lan") * 2.75).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("formAcid").innerHTML += Math.max(0, localStorage.getItem("Formic Acid"));
document.getElementById("formAcidc").innerHTML += (localStorage.getItem("Formic Acid") * 0.7).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("hydroPero").innerHTML += Math.max(0, localStorage.getItem("Hydrogen Peroxide"));
document.getElementById("hydroPeroc").innerHTML += (localStorage.getItem("Hydrogen Peroxide") * 0.52).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("hydroSulf").innerHTML += Math.max(0, localStorage.getItem("Hydroxylamine Sulfate"));
document.getElementById("hydroSulfc").innerHTML += (localStorage.getItem("Hydroxylamine Sulfate") * 8.96).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("miraLTD").innerHTML += Math.max(0, localStorage.getItem("Miralan LTD"));
document.getElementById("miraLTDc").innerHTML += (localStorage.getItem("Miralan LTD") * 5.72).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("miraTOP").innerHTML += Math.max(0, localStorage.getItem("Miralan TOP"));
document.getElementById("miraTOPc").innerHTML += (localStorage.getItem("Miralan TOP") * 3.08).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("saraPaw").innerHTML += Math.max(0, localStorage.getItem("Sarabid Paw"));
document.getElementById("saraPawc").innerHTML += (localStorage.getItem("Sarabid Paw") * 2.6).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("sodAsh").innerHTML += Math.max(0, localStorage.getItem("Soda Ash"));
document.getElementById("sodAshc").innerHTML += (localStorage.getItem("Soda Ash") * 0.44).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("sodAce").innerHTML += Math.max(0, localStorage.getItem("Sodium Acetate"));
document.getElementById("sodAcec").innerHTML += (localStorage.getItem("Sodium Acetate") * 3.19).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("sodBi").innerHTML += Math.max(0, localStorage.getItem("Sodium Bicarbonate"));
document.getElementById("sodBic").innerHTML += (localStorage.getItem("Sodium Bicarbonate") * 0.35).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("sodMeta").innerHTML += Math.max(0, localStorage.getItem("Sodium Metabisulfate"));
document.getElementById("sodMetac").innerHTML += (localStorage.getItem("Sodium Metabisulfate") * 0.45).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("sodSulf").innerHTML += Math.max(0, localStorage.getItem("Sodium Sulfate"));
document.getElementById("sodSulfc").innerHTML += (localStorage.getItem("Sodium Sulfate") * 0.37).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("soloDE3").innerHTML += Math.max(0, localStorage.getItem("Solopol DE3"));
document.getElementById("soloDE3c").innerHTML += (localStorage.getItem("Solopol DE3") * 8.54).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("thiDio").innerHTML += Math.max(0, localStorage.getItem("Thiourea-Dioxide"));
document.getElementById("thiDioc").innerHTML += (localStorage.getItem("Thiourea-Dioxide") * 3.65).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("tinNT").innerHTML += Math.max(0, localStorage.getItem("Tinegal NT"));
document.getElementById("tinNTc").innerHTML += (localStorage.getItem("Tinegal NT") * 4.34).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("ultraCN").innerHTML += Math.max(0, localStorage.getItem("Ultravon CN"));
document.getElementById("ultraCNc").innerHTML += (localStorage.getItem("Ultravon CN") * 2.32).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("uniDPL").innerHTML += Math.max(0, localStorage.getItem("Univadine DPL"));
document.getElementById("uniDPLc").innerHTML += (localStorage.getItem("Univadine DPL") * 1.83).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("uniDFM").innerHTML += Math.max(0, localStorage.getItem("Univadine DFM"));
document.getElementById("uniDFMc").innerHTML += (localStorage.getItem("Univadine DFM") * 3.16).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("uvfPLF").innerHTML += Math.max(0, localStorage.getItem("UV Fast PLF"));
document.getElementById("uvfPLFc").innerHTML += (localStorage.getItem("UV Fast PLF") * 6.08).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("uvfWL").innerHTML += Math.max(0, localStorage.getItem("UV Fast W. Liq."));
document.getElementById("uvfWLc").innerHTML += (localStorage.getItem("UV Fast W. Liq.") * 22.5).toLocaleString("en-IN", { style: "currency", currency: "USD"});
...
document.getElementById("bezYelo").innerHTML += Math.max(0, localStorage.getItem("Bezaktiv Yellow WO-4R"));
document.getElementById("bezYeloc").innerHTML += (localStorage.getItem("Bezaktiv Yellow WO-4R") * 4.48).toLocaleString("en-IN", { style: "currency", currency: "USD"});
...
document.getElementById("lanaCEYelo").innerHTML += Math.max(0, localStorage.getItem("Lanasol Golden Yellow CE-01"));
document.getElementById("lanaCEYeloc").innerHTML += (localStorage.getItem("Lanasol Golden Yellow CE-01") * 11.97).toLocaleString("en-IN", { style: "currency", currency: "USD"});
...
document.getElementById("tect2GYeloc").innerHTML += (localStorage.getItem("Tectilon Yellow 2G 200%") * 1).toLocaleString("en-IN", { style: "currency", currency: "USD"});
...
document.getElementById("teraBRLFYeloc").innerHTML += (localStorage.getItem("Teratop Yellow BRLF") * 1).toLocaleString("en-IN", { style: "currency", currency: "USD"});

/*document.getElementById("teraGWLYelo").innerHTML += Math.max(0, localStorage.getItem("Teratop/Terasil 3R 200%"));
document.getElementById("teraGWLYeloc").innerHTML += (localStorage.getItem("Teratop/Terasil 3R 200%") * ).toLocaleString("en-IN", { style: "currency", currency: "USD"});*/
...
document.getElementById("tera4RLOrngc").innerHTML += (localStorage.getItem("Terasil Orange 4RL") * 1).toLocaleString("en-IN", { style: "currency", currency: "USD"});
...
document.getElementById("bemaF4BRed").innerHTML += Math.max(0, localStorage.getItem("Bemacid Red F-4B"));
document.getElementById("bemaF4BRedc").innerHTML += (localStorage.getItem("Bemacid Red F-4B") * 6.26).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("dorac2BRed").innerHTML += Math.max(0, localStorage.getItem("Dorasyn Red C-2B"));
document.getElementById("dorac2BRedc").innerHTML += (localStorage.getItem("Dorasyn Red C-2B") * 1).toLocaleString("en-IN", { style: "currency", currency: "USD"});
...
document.getElementById("optiScar").innerHTML += Math.max(0, localStorage.getItem("Optilan Scarlet MF-GF 130"));
document.getElementById("optiScarc").innerHTML += (localStorage.getItem("Optilan Scarlet MF-GF 130") * 3).toLocaleString("en-IN", { style: "currency", currency: "USD"});
...
document.getElementById("teraRRedc").innerHTML += (localStorage.getItem("Terasil Red R") * 1).toLocaleString("en-IN", { style: "currency", currency: "USD"});
...
document.getElementById("doraBluec").innerHTML += (localStorage.getItem("Doracid Blue SBL") * 1).toLocaleString("en-IN", { style: "currency", currency: "USD"});
...
document.getElementById("lana8GBlue").innerHTML += Math.max(0, localStorage.getItem("Lanasol Blue 8G 01 150%"));
document.getElementById("lana8GBluec").innerHTML += (localStorage.getItem("Lanasol Blue 8G 01 150%") * 39.62).toLocaleString("en-IN", { style: "currency", currency: "USD"});
...
document.getElementById("tect6GBluec").innerHTML += (localStorage.getItem("Tectilon Blue 6G 200%") * 1).toLocaleString("en-IN", { style: "currency", currency: "USD"});

document.getElementById("teloMGLWBlue").innerHTML += Math.max(0, localStorage.getItem("Telon Blue M-GL W"));
document.getElementById("teloMGLWBluec").innerHTML += (localStorage.getItem("Telon Blue M-GL W") * 57.51).toLocaleString("en-IN", { style: "currency", currency: "USD"});
...
document.getElementById("teraBLFBluec").innerHTML += (localStorage.getItem("Teratop Blue BLF") * 1).toLocaleString("en-IN", { style: "currency", currency: "USD"});
...
document.getElementById("lanaCFRNavyc").innerHTML += (localStorage.getItem("Lanasyn Navy CF-R") * 1).toLocaleString("en-IN", { style: "currency", currency: "USD"});
